      ...
      <div class="recipe-main my-5">
        <section id="ingr-sec">
          ...
          <ul class="ingredient-list">
            <li v-for="(item, index) in recipe.ingredients" :key="`ingredient-${index}`">
        ...
        <section id="inst-sec">
          ...
          <li v-for="(step, index) in recipe.instructions" :key="`step-${index}`">
              {{ `${step}` }}
          </li>
          </ol>
        </section>
...
const getOneRecipeById = async (id) => {
  return Promise.resolve({
      ...
      imageLink: "https://www.seriouseats.com/recipes/images/2016/04/20160323-french-omelet-vicky-wasik--31.jpg",
      ingredients: [{
        ...
        unit: "tablespoon"
          ...
          ingredient:{name: "Kosher salt and freshly ground white or black pepper"},
          quantity: "",
          unit: ""
        }
      ],
